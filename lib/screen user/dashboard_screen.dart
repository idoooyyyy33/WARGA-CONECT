...
class _DashboardScreenState extends State<DashboardScreen> with TickerProviderStateMixin {
              ...
              SliverToBoxAdapter(
                child: FadeTransition(
                  ...
                  child: SlideTransition(
                    ...
                    child: _buildElegantHeader(context, screenHeight, screenWidth),
                  ),
                ),
              ),
  ...
  Widget _buildElegantHeader(BuildContext context, double screenHeight, double screenWidth) {
    return Container(
      ...
      children: [
        Row(
          ...
          children: [
            ...
            TextButton(
              onPressed: () => _navigateToScreen(context, const AnnouncementsScreen()),
